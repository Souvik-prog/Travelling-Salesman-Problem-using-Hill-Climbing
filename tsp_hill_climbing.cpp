...
vector<int> random_solution(int t[][10])
{
    vector<int> cities;
    int i;
...
int RouteLength(int t[][10], vector<int> c)
{
...
vector<vector<int>> GetBestNeighbour(int t[][10], vector<vector<int>> neighbours)
{
